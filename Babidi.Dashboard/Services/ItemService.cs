...
public class ItemService
{
    ...
    [
        ...
        new() { Id = 2, Name = "Pipeline Item", Category = "Sales", Status = "Pending", CreatedDate = DateOnly.FromDateTime(DateTime.Today.AddDays(-2)), Value = 2300 },
        new() { Id = 3, Name = "Archived Item", Category = "Ops", Status = "Archived", CreatedDate = DateOnly.FromDateTime(DateTime.Today.AddDays(-30)), Value = 300 }
    ];
    ...
    public IReadOnlyList<DashboardItem> GetAll(string? query = null)
    {
        ...
        return items.OrderByDescending(x => x.CreatedDate).ToList();
    }
